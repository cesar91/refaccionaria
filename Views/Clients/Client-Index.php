...
<?php  if(isset($_GET['Estado']))
      {
          if($_GET['Estado'] == 'false')
          {
            ...
            echo '<div class="alert alert-warning">
   				 <a href="Client-index.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>
...
<div class="col-md-12 row">
		<div class="col-md-4 col-centered">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<a href="Client-Index.php" title="Agregar Cliente" class="btn">Lista de Clientes</a>
				...
				<div class="panel-footer">
 					...
 					<a href="Client-Index.php" title="Todos los Clientes">Todos Los Clientes</a>
 					</form>
				</div>
			</div>
		</div>
						...
						<table class="table table-hover table-condensed table-bordered table-striped">
								<tr>
 								...
 								<tr>
 									...
 									<td><a href="Edit-Client.php?Id=<?php echo $value['Id'];?>" title="Editar" class="btn btn-default"><i class="glyphicon glyphicon-edit"></i></a></td>
 									<td><a href="Details-Client.php?Id=<?php echo $value['Id'];?>" title="" class="btn btn-default"><i class="glyphicon glyphicon-file"></i></a></td>
 									<td><a href="../../Controller/Delete-ClientController.php?Id=<?php echo $value['Id'];?>" title="" class="btn btn-default"><i class="glyphicon glyphicon-trash"></i></a></td>
 								</tr>
 								<?php endforeach ?>
						</table>
					</div>
		...
		<div class="col-md-8 col-centered" id="newform">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form action="../../Controller/Add-ClientController.php" method="POST">
 					<div class="col-md-6">
