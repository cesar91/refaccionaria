				...
				<div class="table-responsive">
					<table class=" table table-condensed table-hover table-striped table-bordered">
						...
						<tr class="text-center">
							<td><a href="Product-EditU.php?Id=<?php echo $rows['IdProduct']; ?>" title="Editar" class="btn btn-primary">Actualizar</a></td>
							<td><a href="Product-IndexU.php" title="Regresar" class="btn btn-warning">Lista de Productos</a></td>
						</tr>
					</table>
				</div>
			</div>
