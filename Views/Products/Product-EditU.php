    	...
    	<div class="col-md-7 col-centered">
    		<div class="panel panel-warning">
    			...
    			<div class="panel-body">
    				<form action="../../Controller/EditU-ProductController.php" method="POST" accept-charset="utf-8">
    				<div class="col-md-6">
						<input type="text" name="id" value="<?php echo $rows['IdProduct']; ?>" hidden>
	 					...
	 					<div class="form-group">
	 						...
	 						<input type="text" name="quantity" value="<?php echo $rows['Cantidad']; ?>" class="form-control" readonly>
	 					</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
 							<label for="price">Precio</label>
 							<input type="text" name="price" value="<?php echo $rows['Precio']; ?>" class="form-control" readonly>
 						</div>
 						<div class="form-group">
    			...
    			<div class="panel-footer">
    				<div class="form-group col-centered">
 						...
 						<a href="Product-IndexU.php" title="Regresar" class="btn btn-warning">Regresar</a>
 					</div>
 					</form>
    			</div>
    		</div>
