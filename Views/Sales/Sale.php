...
<?php  if(isset($_GET['Estado']))
      {
          if($_GET['Estado'] == 'false')
          {
            ...
            echo '<div class="alert alert-warning">
   				 <a href="Sale.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>
	...
	<div class="col-md-12">
			<div class="col-md-4">
				<div class="panel panel-primary">
					...
					<div class="panel-body ">
						<form action="Sale.php" method="GET" accept-charset="utf-8">
						...
						<table class="table table-condensed table-hovered table-bordered">
							...
							<form action="../../Controller/SaleController.php" method="post">
			...
			<div class="col-md-5">
				<div class="panel panel-primary">
					...
					<div class="panel-body ">
					<form action="../../Controller/SaleConfirm-Controller.php" method="Post">
					...
					<div class="table-responsive">
						...
						<table class="table table-bordered table-hover table-striped table-condensed dataproduct">
								...
								<tr>
									...
									<td><a href="../../Controller/DeleteItem-Controller.php?Id=<?php echo $value['Id'] ?>"><i class="glyphicon glyphicon-trash"></i></a></td>
								</tr>
								 <?php 
