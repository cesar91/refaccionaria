...
<?php  if(isset($_GET['Estado']))
      {
          if($_GET['Estado'] == 'false')
          {
            ...
            echo '<div class="alert alert-warning">
   				 <a href="Supplier-IndexU.php" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  ...
  <div class="col-md-5">
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <form action="../../Controller/Add-SupplierUController.php" method="POST">
        ...
        <table class="table table-bordered table-hover table-condensed table-striped">
          ...
          <?php foreach ($result as $data => $list): ?>
           <tr>
            ...
            <td><a href="Edit-SupplierU.php?Id=<?php echo $list["Id"]?>" title="Modificar" class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i></a></td>
            <td><a href="Details-SupplierU.php?Id=<?php echo $list["Id"]?>" title="Detalle" class="btn btn-primary"><i class="glyphicon glyphicon-file"></i></a></td>
          </tr>
           <?php endforeach ?>
      </table>
      </div>
